...
import cl from './AlloCategoryItem.module.css';
import { IAlloCategoryItem } from '../../../../interfaces/Allo/IAlloCategoryItem';

interface IProps {
    categoryItem: IAlloCategoryItem
    handleItemChange: (categoryItem: IAlloCategoryItem) => void;
}

export const AlloCategoryItem = ({categoryItem, handleItemChange}: IProps) => {
